...
void adicionarPokemons(Treinador &t)
{
    ...
    while (continuar)
    {
        ...
        {
        case 'e':
        { // Usa uma evolution ball para capturar
            std::cin >> id;
        ...
        case 'h':
        { // Usa uma health ball para capturar
            std::cin >> id;
            Pokemon pokemon = criarPokemon();
...
void acoes(Treinador &t)
{
    ...
    while (continuar)
    {
        ...
        {
        case 'e':
        { // Evolui um pokémon de uma evolution ball
            std::cin >> id;
        ...
        case 'h':
        { // Recupera a saúde de um pokémon de uma health ball
            std::cin >> id;
        ...
        case 'i':
        { // Pausa o programa por M milisegundos (M é definido pelo "interval")
        ...
        case 'q':
        { // Encerra o processo de ações com as pokébolas
            continuar = false;
            break;
        }
        }
